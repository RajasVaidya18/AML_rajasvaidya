...
class TestFunction:
    ...
    def spam_test(self):
        label,prop=score.score("Attention!! your paypal account will close soon! confirm your credit card details to continue.",mlp,threshold)
        assert label == 1

    # testing obvious ham
    def ham_test(self):
        label,prop=score.score("I like cricket",mlp,threshold)
        assert label == 0
